...
return {
	...
	-- Core colors
	Background = Color3.fromRGB(67, 67, 76),
	Topbar = Color3.fromRGB(69, 69, 69),
	TabBar = Color3.fromRGB(69, 69, 69),
	ElementBg = Color3.fromRGB(45, 45, 89),
	ElementHoverBg = Color3.fromRGB(30, 12, 56),
